...
class EditPartnerScreen extends Component {
  constructor(props){
    super(props);
    this.state={
      country: '',
  ...
  getPartnerDetail = async ()=>{
    ...
    if(response.status !== 200 ){
        return this.setState({ spin : false, message: "Can't get partner details", modalVisible: true })
    }
    else{
      ...
      if (res.success) {
        ...
        this.setState({
            ...
            facebook: res.message.facebook,
            website: res.message.website,
            instagram: res.message.instagram,
            industry: res.message.industry,
            twitter: res.message.twitter,
            linkedln: res.message.linkedln,
            url: res.message.url,
            profileImage: res.message.profileImage,
            image: res.message.profileImage,
            base64: res.message.profileImage,
        })
      }
...
export default connect(mapStateToProps, {loginAction, getUserIdAction,buyArtworkAction,
   moreArtworkDetailsAction, getUserProfileAction })(EditPartnerScreen)